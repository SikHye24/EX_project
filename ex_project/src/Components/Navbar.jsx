...
export default function Navbar() {
  ...
  return (
      <Box sx={{position : 'fixed', top : '0', width: '100%',height:'70px', backgroundColor: 'white', zIndex: 1000,
      display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '0 20px', overflow : 'hidden'
      }}>
        <Box sx={{marginTop : '10px',marginRight : '1000px', display : 'flex', alignItems : 'center'}}>
